...
import {ionLogoLinkedin, ionLogoGithub, ionOpenOutline, ionDownloadOutline} from '@ng-icons/ionicons'

@Component({
  selector: 'app-links-icons',
  standalone: true,
  imports: [NgIconComponent],
  providers: [provideIcons({ionLogoLinkedin, ionLogoGithub, ionOpenOutline, ionDownloadOutline})],
  template: `
