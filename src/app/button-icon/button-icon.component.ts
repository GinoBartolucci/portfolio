...
@Component({
  ...
  template: `
    <a
      [href]="button.link"
      target="_blank"
      class="button flex justify-center items-center text-center px-2 py-1 animate-fade text-lg xl:text-xl rounded-lg border-2 bg-white shadow-sm hover:shadow-md">
      {{ button.text
